...
KNOWN_CHECKS: dict[str, CheckDecl] = dict(
    [
        ...
        _decl("form.thread_spec_ok", Level.FORM,
              "every modeled thread carries enough turns at a printable fit compensation"),
        _decl("form.ratchet_teeth_ok", Level.FORM,
              "the teeth lock one way and ramp the other at a printable pitch/depth"),
        _decl("form.ratchet_pawl_unverified", Level.FORM,
              "honesty note: the sprung pawl is its own iteration — this is a wheel, not the full mechanism"),
        _decl("form.coupler_bores_ok", Level.FORM,
              "both coupler bores fit, engage and stay separated by the mid web"),
        _decl("form.coupler_torque_unverified", Level.FORM,
              "honesty note: transmissible torque is set-screw preload + plastic, hobby duty"),
        ...
        _decl("form.hinge_pin_fit_ok", Level.FORM,
              "the hinge barrel bore slips the hardware pin inside the band"),
        _decl("form.hinge_knuckle_geometry_ok", Level.FORM,
              "knuckle gap/bite/wall measured — the a+b pair meshes by construction"),
        _decl("form.hinge_motion_unverified", Level.FORM,
              "honesty note: torque/friction/cycle-life are hardware and assembly properties"),
        _decl("form.living_hinge_web_ok", Level.FORM,
              "the living-hinge flex web sits in the fold-without-tearing band"),
        _decl("form.living_hinge_fatigue_unverified", Level.FORM,
              "honesty note: fold-cycle life is a material property AF cannot measure"),
        _decl("form.rail_slider_fit_ok", Level.FORM,
              "the shoe slides its rail: clearances in band, travel beats yaw"),
        _decl("form.rail_slider_walls_ok", Level.FORM,
              "the shoe's side walls and ceiling carry the payload moment"),
        _decl("form.post_sleeve_fit_ok", Level.FORM,
              "the square post channel clears the post inside the sliding band"),
        _decl("form.post_sleeve_engagement_ok", Level.FORM,
        ...
        _decl("topology.thread_present", Level.TOPOLOGY, "every modeled thread helix materialized (ridge solid / groove void)"),
