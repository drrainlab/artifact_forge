...
from artifact_forge_vf.checks import (
...
def test_cap_op_satisfies_checks():
    from artifact_forge_vf.checks import check_cap_water_path_visible
    form = cap_form()
...
def test_cap_chute_drains_under_mount():
    ...
    from artifact_forge_vf.carrier import _cap_chute_drains_under_mount
...
def test_cap_supportless_verified_and_cantilever_mutation():
    ...
    from artifact_forge_vf.manufacturing import (
            cap_supportless_verified)
    cap = cap_form()
