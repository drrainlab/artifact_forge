...
from artifact_forge_vf.frame_report import build_frame_report
from artifact_forge_ng.assembly.pipeline import (
    _inject_shared,
    _joint_findings,
    load_assembly,
)
from artifact_forge_vf.water_report import build_water_report
...
def test_through_receiver_reintroduced_fails_invariant():
    ...
    from artifact_forge_vf.checks import check_lap_receiver_has_floor
    from artifact_forge_vf.manufacturing import (
            no_through_holes_in_wet_lap_zone)
