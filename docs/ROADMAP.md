...
| Ports / Interfaces / Mates | ✅ ядро | A1: реестр 11 типов + InterfaceSpec на архетипах + mate-валидация + `forge compat` + swap-харнес; остаток: normal/up-фреймы, fluid-joints, ретрофит легаси |
